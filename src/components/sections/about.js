...
const About = () => {
  ...
  const skills = ['Python','JavaScript','Node.js', 'React','MongoDB','MySQL', 'Java','Data Science', 'Machine Learning','Automation','WalkMe Digital Adoption Platform','Restful API', 'RAG','Vector Databases', 'LangChain','Docker'];
